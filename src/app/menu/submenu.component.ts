...
export class SubMenuComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    constructor(public logger: LoggerService, public data: DataService,
        ...
        this.appVersion = this.data.uiParams.appVersion;
    }
    ...
    switchProfile(profilename) {
        /**
         * added by gopal:)
         * Fixes the glitch in header bar while switching mode using the menu 
         */
        this.data.setSMMainTitle('');
        this.data.setShowHomeButton(true);
        this.data.setMenuActive(false);
        ...
        switch (this.data.getSubMenuVal()) {
            ...
            case 'sync':
                if (this.data.getIsAbbFlavor() == false)
                    ...
                    this.data.setSMMainTitle('Sync with myABB')
                break;
        }
    }
    ngOnDestroy() {
