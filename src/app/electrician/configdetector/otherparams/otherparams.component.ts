...
export class EOtherParamsComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  onFitterPinChanged() {
    if (this.installer_pwd.length == 0) {
      this.showFitterPin = false;
    }
  ...
  reduceCount(item, isClick) {
    if (item == 'cload') {
      this.ad.energyMonitorConnectedLoad = this.data.getPermanentTapVal(isClick, this.ad.energyMonitorConnectedLoad, 'decrease', this.data.permanentTapStep_1_10_50);
      ...
      this.ad.energyMonitorLightingDuration = this.data.getPermanentTapVal(isClick, this.ad.energyMonitorLightingDuration, 'decrease', this.data.permanentTapStep_1_10);
  ...
  increaseCount(item, isClick) {
    if (item == 'cload') {
      this.ad.energyMonitorConnectedLoad = this.data.getPermanentTapVal(isClick, this.ad.energyMonitorConnectedLoad, 'increase', this.data.permanentTapStep_1_10_50);
      //this.ad.energyMonitorConnectedLoad = this.ad.energyMonitorConnectedLoad + 1;
      ...
      this.ad.energyMonitorLightingDuration = this.data.getPermanentTapVal(isClick, this.ad.energyMonitorLightingDuration, 'increase', this.data.permanentTapStep_1_10);
      // this.ad.energyMonitorLightingDuration = this.ad.energyMonitorLightingDuration + 1;
  ...
  setCName(event: any) {
    ...
    console.log("BUILD ALLOC CON NAME - " + this.contactName + " || CON NAME LEN " + this.contactName.length);
    ...
    //gopal:) 472 PDAL-2818
    this.ad.contact = this.contactName;
    //
  ...
  setBName(event: any) {
    ...
    //gopal:) PDAL-2818
    this.ad.building = this.buildingName;
    //
