...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DeviceListTableViewCell *cell = (DeviceListTableViewCell*) [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    ProximityServiceManager *deviceManager = [self deviceManagerForIndex:indexPath.row];
    [cell setDeviceManager:deviceManager];
    [cell.textLabel setText:deviceManager.deviceName];
    [cell.detailTextLabel setText:deviceManager.identifier];
