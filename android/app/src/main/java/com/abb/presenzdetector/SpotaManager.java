 ...
 */
public class SpotaManager extends BJBLEManager {
...
//                setSpotaGpioMap();
    ...
    private void readMemInfo() {
        ...
        if (activity.getSpotaMemInfoCharacteristic() != null) {
            activity.getGatt().readCharacteristic(activity.getSpotaMemInfoCharacteristic());
        }
        else {
